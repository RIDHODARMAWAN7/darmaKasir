...
<aside class="main-sidebar bg-black sidebar-dark-warning elevation-4">
  <!-- Brand Logo -->
  ...
  <div class="sidebar">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">KASIR CAFFE</span>
    </a>
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <!-- @if(auth()->check())     -->
      <div class="image">
        <img src="/vendor/admin/dist/img/7.jpg" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
